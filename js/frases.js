...
const createHistoriaContent = (storyList) => {
  ...
  return `
    <h2 class="phrases-history__title" data-aos="fade-up" data-aos-delay="50"
      data-aos-anchor-placement=".banner__title">
      ${titulo}
    </h2>
    <figure data-aos="fade-up" data-aos-delay="100" data-aos-anchor-placement=".banner__title">
